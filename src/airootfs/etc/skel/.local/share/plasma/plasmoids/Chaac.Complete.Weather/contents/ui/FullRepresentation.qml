                    ...
                    Lib.Card {
                        ...
                        Column {
                            ...
                            Text {
                                width: parent.width
                                height: parent.height*.3
                                text: weatherData.uvtext ? weatherData.uvtext : "--"
                                color: Kirigami.Theme.textColor
                                verticalAlignment: Text.AlignVCenter
                            ...
                            Text {
                                width: parent.width
                                text: weatherData.uvtext ? weatherData.uvindex : "--"
                                height: parent.height*.3
                                color: Kirigami.Theme.textColor
                                verticalAlignment: Text.AlignVCenter
                                anchors.left: parent.left
                    ...
                    Lib.Card {
                        ...
                        Column {
                            ...
                            Text {
                                height: parent.height*.3
                                color: Kirigami.Theme.textColor
                                text: weatherData.windSpeed ? weatherData.windSpeed + " km/h" : "--"
                                verticalAlignment: Text.AlignVCenter
                                anchors.left: parent.left
                                anchors.leftMargin: height*.5
                            }
                    ...
                    Lib.Card {
                        ...
                        Column {
                            ...
                            Text {
                                ...
                                anchors.left: parent.left
                                anchors.leftMargin: height*.5
                                text: weatherData.probabilidadDeLLuvia ? weatherData.probabilidadDeLLuvia + "%" : "--"
                            }
                        }
                    }
                }
